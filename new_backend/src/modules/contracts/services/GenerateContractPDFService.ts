    ...
    public async execute(contract_id: string): Promise<Contract> {
        ...
        const documentDefinition = {
            ...
            content: [
                ...
                {
                    text: `Documento Emitido em ${dateFnsFormatDate(
                        new Date(),
                        'dd/MM/yyyy',
                    )}`,
                    style: 'subheading',
                ...
                {
                    columns: [
                        `Sr./Sra.: ${financialResponsible.name}`,
                        {
                            alignment: 'right',
                ...
                {
                    columns: [
                        `Telefone Residencial: ${financialResponsible.residencial_phone}`,
                        {
                            alignment: 'center',
                    ...
                    columns: [
                        {
                            width: '*',
                            text: [
                                `Rua ${financialResponsible.address_street}`,
                                `, Nº ${financialResponsible.address_number}`,
                                `, Bairro ${financialResponsible.address_neighborhood}`,
                                `, Cidade ${financialResponsible.address_city}`,
                            ],
                        },
                        {
                ...
                {
                    columns: [
                        `Sr./Sra.: ${supportiveResponsible.name}`,
                        {
                            alignment: 'right',
                ...
                {
                    columns: [
                        `Telefone Residencial: ${supportiveResponsible.residencial_phone}`,
                        {
                            alignment: 'center',
                ...
                },
                {
                    columns: [
                        {
                            text: [
                                `Rua ${supportiveResponsible.address_street}`,
                                `, Nº ${supportiveResponsible.address_number}`,
                                `, Bairro ${supportiveResponsible.address_neighborhood}`,
                                `, Cidade ${supportiveResponsible.address_city}`,
                            ],
                        },
                        {
                ...
                {
                    columns: [
                        `Natural de: ${student.birth_city} - ${student.birth_state}`,
                        {
                            alignment: 'right',
                ...
                `Série/Ano/Período que Cursará: ${grade.name}`,
                // CLÁUSULAS
                // 1ª
                {
                ...
                '\n\n',
                {
                    text: `BETIM, MG\n${dateFnsFormatDate(
                        new Date(),
                        'dd',
                    )} DE ${formatMonthBrazil(
                        dateFnsFormatDate(new Date(), 'MMMM'),
                    )} DE ${dateFnsFormatDate(new Date(), 'yyyy')}`,
                    alignment: 'center',
                },
            ],
        ...
        Object.assign(contract, { contract_document: fileName });
