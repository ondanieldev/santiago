...
let IndexUsersService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec4 = Reflect.metadata("design:type", Function), _dec5 = Reflect.metadata("design:paramtypes", [typeof _IUsersRepository.default === "undefined" ? Object : _IUsersRepository.default, typeof _ICacheProvider.default === "undefined" ? Object : _ICacheProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = class IndexUsersService {
  ...
  async execute() {
    ...
    if (!users) {
      ...
      await this.cacheProvider.register('users', (0, _classTransformer.classToClass)(users));
    }
...
exports.default = IndexUsersService;