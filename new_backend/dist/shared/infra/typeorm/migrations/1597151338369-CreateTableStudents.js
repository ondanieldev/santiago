...
class CreateTableStudents1597151338369 {
  async up(queryRunner) {
    ...
    await queryRunner.createForeignKey('students', new _typeorm.TableForeignKey({
      name: 'StudentsUserId',
      columnNames: ['user_id'],
...
exports.default = CreateTableStudents1597151338369;